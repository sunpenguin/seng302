...
public class BoatsXmlEncoderTest {
    ...
    public void encodeVersionTest() throws Exception {
        final String DEFAULT_VERSION = "12";
        ...
        assertEquals("version has not been correctly encoded", DEFAULT_VERSION, version);
    }
    ...
    public void encodeSettingsTest_raceBoatType() throws Exception {
        ...
        assertEquals("race boat type has not been encoded correctly", DEFAULT_RACE_BOAT_TYPE, type);
    }
    ...
    public void encodeSettingsTest_boatDimension() throws Exception {
        ...
        assertEquals("boat dimension - boat length has not been encoded correctly", DEFAULT_BOAT_LENGTH.toString(), boatLength);
        assertEquals("boat dimension - hull length has not been encoded correctly", DEFAULT_HULL_LENGTH.toString(), hullLength);
    }
    ...
    public void encodeSettingsTest_ZoneSize() throws Exception {
        ...
        assertEquals("mark zone size has not been encoded correctly", DEFAULT_MARK_ZONE_SIZE.toString(), markZoneSize);
        assertEquals("course zone size has not been encoded correctly", DEFAULT_COURSE_ZONE_SIZE.toString(), courseZoneSize);
    }
    ...
    public void encodeSettingsTest_ZoneLimits() throws Exception {
        ...
        assertEquals("zone limit 1 has not been encoded correctly", DEFAULT_LIMIT_1.toString(), limit1);
        assertEquals("zone limit 2 has not been encoded correctly", DEFAULT_LIMIT_2.toString(), limit2);
        assertEquals("zone limit 3 has not been encoded correctly", DEFAULT_LIMIT_3.toString(), limit3);
        assertEquals("zone limit 4 has not been encoded correctly", DEFAULT_LIMIT_4.toString(), limit4);
        assertEquals("zone limit 5 has not been encoded correctly", DEFAULT_LIMIT_5.toString(), limit5);
    }
    ...
    public void encodeBoatTest_hullNumber() throws Exception {
        String DEFAULT_HULL_NUMBER = "AC4500";
        ...
        for (int i = 0; i < boatNodes.getLength(); i++) {
            ...
            assertEquals(String.format("hull number for boat %d has not been encoded correctly", i), DEFAULT_HULL_NUMBER, encodedHullId);
        }
    }
    ...
    public void encodeBoatTest_stoweName() throws Exception {
        ...
        for (int i = 0; i < boatNodes.getLength(); i++) {
            ...
            assertEquals(String.format("stowe name for boat %d has not been encoded correctly", i), DEFAULT_STOWE_NAME, encodedStoweName);
        }
    }
    ...
    public void encodeBoatTest_gps() throws Exception {
        ...
        for (int i = 0; i < boatNodes.getLength(); i++) {
            ...
            assertEquals(String.format("gps x for boat %d has not been encoded correctly", i), DEFAULT_GPS_X.toString(), encodedX);
            assertEquals(String.format("gps y for boat %d has not been encoded correctly", i), DEFAULT_GPS_Y.toString(), encodedY);
            assertEquals(String.format("gps z for boat %d has not been encoded correctly", i), DEFAULT_GPS_Z.toString(), encodedZ);
        }
    }
    ...
    public void encodeBoatTest_flag() throws Exception {
        ...
        for (int i = 0; i < boatNodes.getLength(); i++) {
            ...
            assertEquals(String.format("flag x for boat %d has not been encoded correctly", i), DEFAULT_FLAG_X.toString(), encodedX);
            assertEquals(String.format("flag y for boat %d has not been encoded correctly", i), DEFAULT_FLAG_Y.toString(), encodedY);
            assertEquals(String.format("flag z for boat %d has not been encoded correctly", i), DEFAULT_FLAG_Z.toString(), encodedZ);
        }
    }
}